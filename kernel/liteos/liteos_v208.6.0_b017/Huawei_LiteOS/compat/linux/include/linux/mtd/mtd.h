...
struct mtd_info {
    ...
    int (*read)(struct mtd_info *mtd, loff_t from, size_t len, size_t *retlen, char *buf);
    int (*write)(struct mtd_info *mtd, loff_t to, size_t len, size_t *retlen, const char *buf);
    int (*read_oob)(struct mtd_info *mtd, loff_t from, size_t len, size_t *retlen, char *buf);
