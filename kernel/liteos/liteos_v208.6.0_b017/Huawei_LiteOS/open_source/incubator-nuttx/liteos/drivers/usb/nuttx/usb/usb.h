...
#define USB_REQ_SETSEL                          (0x30)
#define USB_REQ_SETISOCHDELAY                   (0x31)
...
#define USB_FEATURE_U1ENABLE                     48
#define USB_FEATURE_U2ENABLE                     49
#define USB_FEATURE_LTMENABLE                    50
...
struct usb_ss_comp_epdesc_s
{
  uint8_t  len;               /* Descriptor length */
  uint8_t  type;              /* Descriptor type */
  uint8_t  maxburst;          /* Max Burst */
  uint8_t  attr;              /* Endpoint attributes */
  uint8_t  interval[2];       /* Bytes per interval */
};
