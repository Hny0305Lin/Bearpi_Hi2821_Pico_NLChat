...
flash_cmd_execute_t *sfc_port_get_flash_protect_cmds(uint32_t flash_id, uint8_t region);
flash_cmd_execute_t *sfc_port_get_flash_unprotect_cmds(uint32_t flash_id);
#ifdef __cplusplus
#if __cplusplus
}
#endif /* __cplusplus */
